...
import static controller.PengeluaranController.pengeluaranImplement;
import static controller.PengeluaranController.pengeluaranTableModel;
import entity.PengeluaranEntity;
import implement.PengeluaranImplement;
import table.PengeluaranTableModel;
    ...
    public void buttonHapusAction(PengeluaranView pengeluaranView) {
        try {
            ...
            if (rowSelected == -1) {
                ...
                String nama = pengeluaranTableModel.get(rowSelected).getNamaTambak();
        ...
        try {
            if (PengeluaranView.textIdKebun.getText().equals("")) {
                ...
                pengeluaranEntity.setIdTambak(Integer.valueOf(PengeluaranView.textIdKebun.getText()));
                pengeluaranEntity.setBiayaIkan(new BigDecimal(PengeluaranView.textBiayaTanaman.getText()));
    ...
    public void tableDataAction(PengeluaranView pengeluaranView) {
        PengeluaranView.tableData.getSelectionModel().addListSelectionListener(new ListSelectionListener() {
            ...
            public void valueChanged(ListSelectionEvent e) {
                ...
                if (row != -1) {
                    ...
                    PengeluaranView.textIdKebun.setText(Integer.toString(pengeluaranEntity.getIdTambak()));
                    PengeluaranView.textNama.setText(pengeluaranEntity.getNamaTambak());
                    ...
                    PengeluaranView.textBiayaTanaman.setText(pengeluaranEntity.getBiayaIkan().toString());
       ...
       public void cariKebunAction(PengeluaranView pendapatanView) {
        try {
            ...
            TambakCariView.labelView.setText("PENGELUARAN");
